...
namespace Bastion.Estrangular
{
    public class LariatEspinosaCardController : HumanSnakeUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddReduceDamageTrigger((DealDamageAction dda) => ActivateSnake && dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.Card == base.CharacterCard && base.CharacterCard.IsFlipped, (DealDamageAction dda) => 1);
        }
    }
}
