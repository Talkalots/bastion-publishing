...
namespace Bastion.Estrangular
{
    public class SpursVillarosaCardController : HumanSnakeUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddStartOfTurnTrigger((TurnTaker tt) => tt.IsHero, (PhaseChangeAction pca) => DealDamage(base.Card, base.CharacterCard, 1, DamageType.Melee, cardSource: GetCardSource()), TriggerType.DealDamage, (PhaseChangeAction pca) => ActivateSnake);
        }
    }
}
